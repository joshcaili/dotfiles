...
local in_vscode = vim.g.vscode == true
...
-- Normal mode: ZA to quit all windows without saving
vim.keymap.set("n", "ZA", "<cmd>qa!<CR>", { desc = "Quit all without saving" })

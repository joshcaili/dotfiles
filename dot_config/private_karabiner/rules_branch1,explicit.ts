...
const rules: KarabinerRules[] = [
    ...
    },
    {
        ...
        },
        {
            ...
            "description": "Symbol layer explicit command brackets (x+comma+2/3)",
            "manipulators": [
                {
                    "type": "basic",
                    "from": {
                    ...
                    "conditions": [
                        { "type": "variable_if", "name": "num", "value": 0 },
                        { "type": "variable_if", "name": "symbol", "value": 1 },
    ...
    // --- MAIN LAYOUT ---
{
    ...
    // ]
     ...
     [        // row 1  for  if you want dusk duskShiftedBOTHpiantor_QWERTMODprofile | if you want dusk_BothSidepiantor-QWERT_BuiltinMac-ModProfile | dusk_LHSpiantor-qwert_BuiltinMac-ModProfile,
        { "type": "basic", "from": { "key_code": "grave_accent_and_tilde", "modifiers": { "optional": ["any"] } }, "to": [{ "key_code": "tab" }], "conditions": [{ "type": "variable_if", "name": "num", "value": 0 }, { "type": "variable_if", "name": "symbol", "value": 0 }, { "type": "variable_if", "name": "hyper", "value": 0 }] },
        { "type": "basic", "from": { "key_code": "1", "modifiers": { "optional": ["any"] } }, "to": [{ "key_code": "tab" }], "conditions": [{ "type": "variable_if", "name": "num", "value": 0 }, { "type": "variable_if", "name": "symbol", "value": 0 }, { "type": "variable_if", "name": "hyper", "value": 0 }] },
...
const vivaldi = [
    ...
    // {
    //     "description": "10. Vivaldi open dupe profiles via trackpad (Left + Bottom half only, no frontmost check)",
    //     "manipulators": [
    //         {
    //             "conditions": [
    //                 {
...
const modtap = [
    // --- LAYER TRIGGERS ---
// { "description": "num layer n", "manipulators": [{ "type": "basic", "from": { "key_code": "right_command", "modifiers": { "optional": ["any"] } }, "to": [{ "set_variable": { "name": "num", "value": 1 } }], "to_after_key_up": [{ "set_variable": { "name": "num", "value": 0 } }], "conditions": [{ "type": "device_if", "identifiers": [{ "vendor_id": 1452, "product_id": 834 }] }] }] },
...
{
  description: "num layer n",
  manipulators: [
    {
      type: "basic",
      from: { key_code: "right_command", modifiers: { optional: ["any"] } },
      to: [{ set_variable: { name: "num", value: 1 } }],
      to_after_key_up: [{ set_variable: { name: "num", value: 0 } }]
    }
  ]
},
{
...
const layers = [
    ...createHyperSubLayers({
        ...
        "2":    { to: [{ key_code: "f2" }] },
        "3":    { to: [{ key_code: "f3" }] },
        "4":    { to: [{ "key_code": "left_arrow", "modifiers": ["left_option"] }]},
        "5":    { to: [{ "key_code": "right_arrow", "modifiers": ["left_option"] }]},
        "6":    { to: [{ key_code: "f6" }] },
    ...
    ...createNumLayer({
        ...
        "a": { to: [
            ...
            { shell_command: "/Applications/Vivaldi.app/Contents/MacOS/Vivaldi --profile-directory='Default'", conditions: [{ type: "frontmost_application_if", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] },
            { key_code: "f14", conditions: [{ type: "frontmost_application_unless", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] }
        ]},
        "s": { to: [
            { key_code: "w", modifiers: ["left_command", "left_shift"] },
            { hold_down_milliseconds: 120, key_code: "vk_none" },
            { shell_command: "/Applications/Vivaldi.app/Contents/MacOS/Vivaldi --profile-directory='Profile 1'", conditions: [{ type: "frontmost_application_if", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] },
            { key_code: "f15", conditions: [{ type: "frontmost_application_unless", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] }
        ]},
        "d": { to: [
            { key_code: "w", modifiers: ["left_command", "left_shift"] },
            { hold_down_milliseconds: 120, key_code: "vk_none" },
            { shell_command: "/Applications/Vivaldi.app/Contents/MacOS/Vivaldi --profile-directory='Profile 2'", conditions: [{ type: "frontmost_application_if", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] },
            { key_code: "f16", conditions: [{ type: "frontmost_application_unless", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] }
        ]},
        "f": { to: [
            { key_code: "w", modifiers: ["left_command", "left_shift"] },
            { hold_down_milliseconds: 120, key_code: "vk_none" },
            { shell_command: "/Applications/Vivaldi.app/Contents/MacOS/Vivaldi --profile-directory='Profile 5'", conditions: [{ type: "frontmost_application_if", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] },
            { key_code: "f17", conditions: [{ type: "frontmost_application_unless", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] }
        ]},
        "caps_lock": { to: [
            { key_code: "w", modifiers: ["left_command", "left_shift"] },
            { hold_down_milliseconds: 120, key_code: "vk_none" },
            { shell_command: "/Applications/Vivaldi.app/Contents/MacOS/Vivaldi --profile-directory='Profile 4'", conditions: [{ type: "frontmost_application_if", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] },
            { key_code: "f18", conditions: [{ type: "frontmost_application_unless", bundle_identifiers: ["^com\\.vivaldi\\.Vivaldi$"] }] }
        ]},
    ...
    ...createSymbolLayer({
        ...
        // Top (number row)
        // "grave_accent_and_tilde": { to: [{ key_code: "" }]},
        // "1":    { to: [{ key_code: "backslash" }] },
        "grave_accent_and_tilde": {to: [{ key_code: "backslash","modifiers": ["left_shift"]}],},
        "2":    { to: [{ key_code: "open_bracket" }] },
        "3":    { to: [{ key_code: "close_bracket" }] },
        "4":    { to: [{ key_code: "hyphen", modifiers: ["left_shift"] }] },
        "5":    { to: [{ key_code: "equal_sign", modifiers: ["left_shift"] }] },

        "8":    { to: [{ key_code: "hyphen" }] },
        "9":    { to: [{ key_code: "equal_sign" }] },
        "0":    { to: [{ key_code: "open_bracket" , modifiers: ["left_shift"]}] },
        "hyphen":    { to: [{ key_code: "close_bracket" , modifiers: ["left_shift"]}] },
        "equal_sign":    { to: [{ key_code: "backslash" }] },
        "backspace":    { to: [{ key_code: "vk_none" }] },
//row 2
        "tab": {to: [{ key_code: "backslash"}]},
...
//row3
        ...
        // "k":    { to: [{ key_code: "f13", modifiers: ["left_shift"] }] },
